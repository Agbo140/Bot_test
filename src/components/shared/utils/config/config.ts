...
export const domain_app_ids = {
    ...
    'localhost:8443': APP_IDS.GITHUB_DEV,
    // Add your Cloudflare domain
    'https://bot-2zd.pages.dev/': APP_IDS.GITHUB_DEV,
};
...
export const isTestLink = () => {
    return (
        ...
        window.location.origin?.includes('https://bot-2zd.pages.dev/') || // Add your Cloudflare domain here
        isLocal()
    );
};
...
export const getDefaultAppIdAndUrl = () => {
    ...
    if (isTestLink()) {
        return { app_id: APP_IDS.GITHUB_DEV, server_url }; // Changed to use your app ID for local testing
    }
...
export const getAppId = () => {
    ...
    if (config_app_id) {
        ...
        app_id = APP_IDS.GITHUB_DEV; // Changed to use your app ID for local testing
    } else {
